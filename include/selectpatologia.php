...
?>
	...
	$(document).ready(function(){
		...
		$('#tipo_patologia').find('option').remove().end().append('<option value="whatever"></option>').val('whatever');
					
		$("#patologia option:selected").each(function () {
			id_patologia = $(this).val();
			$.post("../php/gettpatologia.php", { id_patologia: id_patologia }, function(data){
