...
function buscar() {
    ...
    window.location.href = 'http://localhost/sistemas/sistema_servicios_medicos/php/registrocfamiliar.php?opcion=' +
        opcion;
}
</script>
...
<body>
    ...
    <div align="center">
            ...
            <table width="414" class="tabla" border="0" align="center">
                <tbody>
                    <tr>
                        ...
                        <td width="136"><select name="familiar" class="textbox" id="familiar"
                                onchange="return buscar();">
     ...
     if(isset($nficha)){?>
                        <input type="text" class="textbox" size="3" name="numerof" value="<?php echo $nficha ?>"
                            readonly />
                        <?php
     ...
     if(isset($dia)){?>
                        <input type="text" class="textbox" size="11" name="fechan"
                            value="<?php echo $dia; echo -$mes; echo -$año; ?>" readonly />
                        <?php
     ...
     ?>
                ...
                <tr>
                    ...
                    <td><textarea name="diagnostico" class="textbox" id="diagnostico" cols="45" rows="5" maxlength="300"
            ...
            <div>
                <table border="0">
                    ...
                    <td><a href="../php/registrocfamiliar.php" title="Borrar"><img src="../imagenes/borrar.png"
                                width="30" height="30" border="0"></a>
                    <td>
                    <td><a href="../php/index.php" title="Volver"><img src="../imagenes/regresar.png" width="30"
