...
<head>
    ...
    $(document).ready(function() {
        ...
        $(".btnAction").on("click", function() {
            ...
            if ($("#IdCedula").val() == '' || $("#Nombre").val() == '' || $("#Ficha").val() == '' || $(
                    "#Apellido").val() == '' || $("#FechaSalida").val() == '' || $("#FechaReintegro")
                .val() == '' || $(":radio[name='seleccion_si1']").is(":checked") == false || $(
                    ":radio[name='seleccion_s1']").is(":checked") == false) {
                ...
                $.ajax({
                    ...
                    data: "&Cedula=" + $("#IdCedula").val() + "&Nombre=" + $("#Nombre").val() +
                        "&Ficha=" + $("#Ficha").val() + "&FechaSalida=" + $("#FechaSalida")
                        .val() + "&FechaReintegro=" + $("#FechaReintegro").val() +
                        "&Function=" + Action + "&cita_pre=" + $(
                            ":radio[name='seleccion_si1'] :checked").val() + "&cita_post=" + $(
                            ":radio[name='seleccion_s1'] :checked").val(),

                    dataType: "html",
                    success: function(data) {
                        console.log(data);
                        if (data == "1") {
                            $("#IdCedula, #Nombre, #Ficha, #FechaSalida, #FechaReintegro, #FechaSalida")
                                .val('');
                            // $("input [type='text']").val('');
    ...
    <form action="Pre-vacacional.php" method="post" name="form" id="form2" onSubmit="javascript: return validar(this);">
        <table align="center">
            <tr>
                ...
                <td width="144" align="left" valign="middle"><input type='text' name="cedula" id="cedula" class="cedula"
                        value=""></td>
                <td width="83" align="left" valign="top"><button type="submit" name="enviar" id="enviar" title="buscar"
                        class="color" value="1"><img src="../imagenes/bucar.png" width="61" height="51"
                            id="guardar" /></button></td>
                <td width="83" align="left" valign="top"><button id="redireccionar" name="redireccionar" class="color"
                        value="5"><img src="../imagenes/regresar.png" width="61" height="51" id="guardar" /></button>
                </td>
            </tr>
        </table>
        <?php
...
while($rows=mysql_fetch_array($resultado)){
        ...
        <form action="" method="post" name="form1" id="form">
            ...
            <table width="58%" border="0" align="center" cellpadding="7" cellspacing="0">
                ...
                <tr>
                    <td width="136">&nbsp;</td>
                    <td width="136" height="37">
                        <div>Cedula:</div>
                    </td>
                    <td width="120"><input id="IdCedula" name="Idcedula" type="text" size="20" maxlength="30"
                            value="<? echo $rows['cedula'];?>" readonly /></td>
                    <td colspan="2">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td height="36" colspan="3"><input id="Ficha" name="Ficha" type="number" size="20" maxlength="30"
                            value="<? echo $rows['numerof']; ?>" readonly /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td height="36">
                    ...
                    <td height="36" colspan="3"><input id="Nombre" name="nombres" type="text" size="20" maxlength="30"
                            value="<? echo $rows['nombre']; ?>" readonly /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td height="36">
                    ...
                    <td height="36" colspan="3"><input id="FechaSalida" name="fecha de salida" type="date" size="20"
                            maxlength="30"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td height="36">
                        <div>Fecha De Reintegro:</div>
                    </td>
                    <td height="36" colspan="3"><input id="FechaReintegro" name="fecha de reintegro" type="date"
                            size="20" maxlength="30"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td height="36">
                        <div>Cita Pre-Vacacional:</div>
                    </td>
                    <td><label> Si <input type="radio" name="seleccion_si1" value="1" id="CitaPrevacional1" />
                        ...
                        <label></label>
                    <td width="145">
                        <div>Cita Pos-Vacacional:</div>
                    </td>
                    <td width="196"> &nbsp; Si <input type="radio" name="seleccion_s1" value="1"
                            id="CitaPostvacional1" />
