    ...
    $(document).ready(function() {
        ...
        $(".btnAction").on("click", function() {
            ...
            if ($("#Cedula").val() == '' || $("#Nombre").val() == '' || $("#Apellido").val() == '' || $(
                    "#InicioReposo").val() == '' || $("#TerminoReposo").val() == '' || $("#Diagnostico")
                .val() == '' || $("#Observacion").val() == '') {
                ...
                $.ajax({
                    ...
                    data: "&Cedula=" + $("#Cedula").val() + "&Nombre=" + $("#Nombre").val() +
                        "&Apellido=" + $("#Apellido").val() + "&InicioReposo=" + $(
                            "#InicioReposo").val() + "&TerminoReposo=" + $("#TerminoReposo")
                        .val() +
                        "&Diagnostico=" + $("#Diagnostico").val() + "&Observacion=" + $(
                            "#Observacion").val() + "&Function=" + Action,
                    ...
                    success: function(data) {
                        if (data == '') {
                            ...
                            if (data[0].tipo_reposo = "Laboral") {
                                ...
                                $("#RadioNolaboral, #RadioMaternidad").prop('checked',
                                ...
                                $("#Radiolaboral, #RadioMaternidad").prop('checked', false)
                                    .prop('disabled', true);
                                ...
                                $("#DivNoLaboral").removeClass("hidden");
                                $("#DivLaboral, #DivMaternidad").addClass("hidden");
                                $("#RadioNolaboral, #Radiolaboral").prop('checked', false)
                                    .prop('disabled', true);
...
<body>
    ...
    <table align="center">
        <tr>
            ...
            <td width="163" align="left" valign="middle"><input type='text' name="cedula" id="cedula" class="cedula"
                    value=""></td>
            <td width="91" align="left" valign="top"><button type="submit" name="enviar" id="enviar" title="buscar"
                    class="color" value="1"><img src="imagenes/bucar.png" width="61" height="51"
                        id="guardar" /></button></td>
            <td width="197" align="left" valign="top"><button id="redireccionar" name="redireccionar" class="color"
                    value="5"><img src="imagenes/regresar.png" width="61" height="51" id="guardar" /></button></td>
        </tr>
    </table>
        ...
        <div class="contenedor">
            <p class="copy">
                <strong>
                    ...
                    <em>Cemento Andino S.A<br>Gerencia de Tecnologia &copy; 2017<br>Desarrollado Por:<br>David
                        Santiago</em>
