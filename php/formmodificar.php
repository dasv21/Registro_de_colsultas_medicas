...
<tr>
<td><center><div><h4>Editando Consulta Nº<?php echo $id_registros_familiar;?><br><?php echo $nombref;?> <?php echo $apellidof;?> <h4></div></center></td>
</tr>
</table>
   <table width="854" class="tabla" border="0">
     <tr>
      <td><input type="hidden" name="id_registros_familiar"  id="id_registros_familiar" value="<?php echo $id_registros_familiar ?>" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    ...
    <?php                
     if(isset($numerof)){?>
     <input type="text" class="textbox" size="3" name="numerof" value="<?php echo $numerof ?>" readonly/>
        <?php
        }else{?>
     ...
     ?></td>
      ...
      <td>Fecha de Consulta</td>
		<td><?php
     if(isset($nombref)){?>
     <input class="textbox" size="11" name="fecham" id="fecham" value="<?php echo $fechaconn ?>" required>
     <?php
     }else{?>
...
<td><?php
      if(isset($fechan)){?>
     <input type="text" class="textbox" size="11" name="fechan" value="<?php echo $fechan; ?>" readonly />
     <?php
...
<td><?php
     if(isset($sexof)){?>
     <input class="textbox" type="text" size="1" name="sexof" value="<?php echo $sexof ?>" readonly />
     <?php
...
<td><?php
     if(isset($edadf)){?>
     <input class="textbox" type="number" size="1" name="edadf" min=0 max="120" value="<?php echo $edadf ?>"required/>
     <?php
...
<textarea name="diagnostico" class="textbox" id="diagnostico" cols="45" rows="5" maxlength="300" required><?php echo $diagnostico ?></textarea></td>




<td>Observaciones:</td>
<td><textarea name="observacion" class="textbox" id="observacion" cols="45" rows="5" maxlength="300" required><?php echo $observacion ?></textarea></td>
</tr>
</tbody>
</table>
...
<table border="0">
  ...
  <td>&nbsp;</td>
    ...
    <td><a href="reportecfamiliar.php" title="Volver"><img src="../imagenes/regresar.png" width="40" height="30" border="0"></a></td>
</table>
</div>
</center>
</form>
